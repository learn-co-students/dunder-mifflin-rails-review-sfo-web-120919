...
Employee--> 1 single dog --> Many owners


- For our index page for Dogs, a user should be able to click on a specific dog and take them to the corresponding show page. **DONE**
